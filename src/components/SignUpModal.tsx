    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md relative">
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6">Join Nexus 360 to unlock full media planning potential</p>
          ...
          <div className="mt-6">
            ...
            <button
              type="button"
              className="mt-4 w-full py-2 px-4 border border-gray-300 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
              onClick={() => {/* Google sign up handler */}}
            >
